      ...
      if myList[count] == "57":
        ...
        if not(firstPassOfX):
          if not(firstPassOfY):
            if nextLineX == lineX:
              if nextLineY == lineY:
                myFinalList.append(lineX)
                myFinalList.append(lineY)
        ...
        # IF Code 57 is NEGATIVE (RELEASED)
          ...
          if (goodNumberMarshall % 4) != 0:
                if lineY != 0:
                  ...
                  if marshallLineY != 0:
                    myFinalList.append(marshallLineX)
                    myFinalList.append(marshallLineY)
                    goodNumberMarshall += 2

                else:
                  myFinalList.append(nextLineX)
                  myFinalList.append(nextLineY)
                  goodNumberMarshall += 2
          if (goodNumberMarshall % 4) != 0:
            myFinalList.append(nextLineY)
